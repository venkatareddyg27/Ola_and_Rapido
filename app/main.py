...
from app.routers.customer_parcels import (router as customer_parcels_router)
from app.routers.drivers import (router as drivers_router)
from app.routers.driver_parcel import (router as driver_parcels_router)
...
app.include_router(customer_parcels_router)
app.include_router(drivers_router)
app.include_router(driver_parcels_router)
