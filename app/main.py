...
from app.routers.customer_rental_booking import (router as rentals_router)
...
from app.routers.rented_vehicles import (router as rented_vehicle_router)
@asynccontextmanager
...
app.include_router(rented_vehicle_router)
