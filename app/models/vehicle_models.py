...
from sqlalchemy import (
    ...
    ForeignKey, Numeric, Integer, Enum as SqlEnum
)
...
class Vehicle(Base):
    ...
    transmission_type = Column(SqlEnum(TransmissionType), nullable=False)
    ...
    drivers = relationship("DriverProfile", back_populates="vehicle") 
...
class VehicleInsurance(Base):
    ...
    insurance_amount = Column(Numeric(12, 2))
...
class VehicleMaintenanceLog(Base):
    ...
    maintenance_cost = Column(Numeric(10, 2))
...
class VehicleTrackingDevice(Base):
    ...
    device_imei = Column(String(255), unique=True)
    provider_name = Column(String(255))
