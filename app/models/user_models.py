...
from sqlalchemy import Column, String, DateTime, Enum, ForeignKey, Numeric, Integer, Boolean
from sqlalchemy.dialects.postgresql import UUID
from sqlalchemy.orm import relationship

from app.core.database import Base
from app.core.enums import UserRole, UserStatus, DriverStatus, SubscriptionPlan, OTPPurpose
...
class User(Base):
    ...
    # FIXED: duplicate relationship removed ambiguity
