...
class KycDocument(Base):
    ...
    ocr_extracted_data = Column(JSONB,nullable=True,)
    ocr_confidence_score = Column(Numeric(5, 2),nullable=True,)
...
class AadhaarEkycSession(Base):
    ...
    otp_transaction_id = Column(String(255),nullable=True,)
    aadhaar_last_4 = Column(String(4),nullable=True,)
    aadhaar_tokenized_id = Column(String(100),nullable=True,)
    uidai_response_encrypted = Column(Text,nullable=True,)
    uidai_xml_encrypted = Column(Text,nullable=True,)
    verified_name = Column(String(255),nullable=True,)
    verified_dob = Column(Date,nullable=True,)
    verified_gender = Column(String(10),nullable=True,)
    verified_address = Column(Text,nullable=True,)
    verified_photo_hash = Column(String(100),nullable=True,)
    liveness_selfie_url = Column(Text,nullable=True,)
    liveness_confidence = Column(Numeric(5, 2),nullable=True,)
    liveness_passed = Column(Boolean,default=False,)
    status = Column(Enum(AadhaarEkycStatus),default=AadhaarEkycStatus.otp_sent,nullable=False,)
