...
class RentedVehicle(Base):
    ...
    ### Relationships
    owner = relationship("User",back_populates="rented_vehicles")
    photos = relationship("RentedVehiclePhoto",back_populates="rented_vehicle",cascade="all, delete-orphan")
    rentals = relationship("Rental",back_populates="rented_vehicle")
    rentedVehicleDocuments = relationship("RentedVehicleDocument",back_populates="rented_vehicle",cascade="all, delete-orphan")
    trip_invoices = relationship("TripInvoice",back_populates="rented_vehicle")
    damage_reports = relationship( "VehicleDamageReport", back_populates="rented_vehicle", cascade="all, delete-orphan" )
    availability_slots = relationship( "VehicleAvailability", back_populates="rented_vehicle", cascade="all, delete-orphan" )
